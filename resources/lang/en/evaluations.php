...
return [
    ...
    'post' => 'Post',
    'post__placeholder' => 'Enter post here...',
    'notes' => 'Notes',
    'etat' => 'Etat',
    'etat__placeholder' => 'Enter etat here...',
    'rating' => 'Rating',
    'rating__placeholder' => 'Enter rating here...',
    'user_id' => 'User',
    'user_id__placeholder' => 'Select user',
    'evaluator_id' => 'Evaluator',
    'evaluator_id__placeholder' => 'Select evaluator',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing evaluations.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the evaluation property name where the value is the assigned value to the retrieved evaluation.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved evaluation.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of evaluations per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved evaluation.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new evaluation.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing evaluation.',
    ...
    'show_route_description' => 'Retrieve existsing evaluation.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the evaluation to retrieve',
    'destroy_route_description' => 'Delete existsing evaluation.',
    ...
    'the_id_of_model_to_delete' => 'The id of the evaluation to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete evaluations.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the evaluation.',
    ...
    'the_requested_model_does_not_exists' => 'The requested evaluation does not exists.',
    ...
    'show' => 'Show Evaluation',
    'show_all' => 'Show All Evaluation',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Evaluation.',
    'none_available' => 'No Evaluations Available.',
    'model_plural' => 'Evaluations',
    'model_was_added' => 'Evaluation was successfully added.',
    'model_was_retrieved' => 'Evaluation was successfully retrieved.',
    'models_were_retrieved' => 'Evaluations were successfully retrieved.',
    'model_was_updated' => 'Evaluation was successfully updated.',
    'model_was_deleted' => 'Evaluation was successfully deleted.',
    ...
    'model_id_camel_case' => 'evaluationId',
